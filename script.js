...
function loadFinalRoutine() {
    ...
    const routineData = [
        {
            day: 1, date: '০৮/০২/২০২৬', isoDate: '2026-02-08T09:00:00', title: 'গণিত: MCQ ও জ্ঞান/অনুধাবন (Day-1)',
            subjects: ['অধ্যায় ২: সেট ও ফাংশন', 'অধ্যায় ৩: বীজগাণিতিক রাশি', 'অধ্যায় ১১: বীজগাণিতিক অনুপাত ও সমানুপাত']
        },
        {
            day: 2, date: '০৯/০২/২০২৬', isoDate: '2026-02-09T09:00:00', title: 'গণিত: MCQ ও জ্ঞান/অনুধাবন (Day-2)',
            subjects: ['অধ্যায় ৭: ব্যবহারিক জ্যামিতি', 'অধ্যায় ৮: বৃত্ত', 'অধ্যায় ১৭: পরিসংখ্যান']
        },
        {
            day: 3, date: '১০/০২/২০২৬', isoDate: '2026-02-10T09:00:00', title: 'গণিত: MCQ ও জ্ঞান/অনুধাবন (Day-3)',
            subjects: ['অধ্যায় ৯: ত্রিকোণমিতিক অনুপাত', 'অধ্যায় ১৬: পরিমিতি']
        },
        {
            day: 4, date: '১১/০২/২০২৬', isoDate: '2026-02-11T09:00:00', title: 'গণিত পরীক্ষা (MCQ ও জ্ঞান/অনুধাবন)',
            subjects: ['সম্পূর্ণ গণিত রিভিশন ও মডেল টেস্ট'], isExam: true
        },
        {
            day: 5, date: '১২/০২/২০২৬', isoDate: '2026-02-12T09:00:00', title: 'উচ্চতর গণিত: MCQ ও জ্ঞান/অনুধাবন (Day-1)',
            subjects: ['অধ্যায় ২: বীজগাণিতিক রাশি', 'অধ্যায় ৭: অসীম ধারা', 'অধ্যায় ১০: দ্বিপদী বিস্তৃতি']
        },
        {
            day: 6, date: '১৩/০২/২০২৬', isoDate: '2026-02-13T09:00:00', title: 'উচ্চতর গণিত: MCQ ও জ্ঞান/অনুধাবন (Day-2)',
            subjects: ['অধ্যায় ৮: ত্রিকোণমিতি (আংশিক)', 'অধ্যায় ৯: সূচকীয় ও লগারিদমীয় ফাংশন']
        },
        {
            day: 7, date: '১৪/০২/২০২৬', isoDate: '2026-02-14T09:00:00', title: 'উচ্চতর গণিত: MCQ ও জ্ঞান/অনুধাবন (Day-3)',
            subjects: ['অধ্যায় ১০: দ্বিপদী বিস্তৃতি', 'অধ্যায় ১১: (সিলেবাস অনুযায়ী)', 'অধ্যায় ১২: সমতলীয় ভেক্টর']
        },
        {
            day: 8, date: '১৫/০২/২০২৬', isoDate: '2026-02-15T09:00:00', title: 'উচ্চতর গণিত পরীক্ষা (MCQ ও জ্ঞান/অনুধাবন)',
            subjects: ['সম্পূর্ণ উচ্চতর গণিত রিভিশন'], isExam: true
        },
        {
            day: 9, date: '১৬/০২/২০২৬', isoDate: '2026-02-16T09:00:00', title: 'পদার্থবিজ্ঞান: MCQ ও জ্ঞান/অনুধাবন (Day-1)',
            subjects: ['অধ্যায় ১: ভৌত রাশি ও পরিমাপ', 'অধ্যায় ২: গতি', 'অধ্যায় ৩: বল']
        },
        {
            day: 10, date: '১৭/০২/২০২৬', isoDate: '2026-02-17T09:00:00', title: 'পদার্থবিজ্ঞান: MCQ ও জ্ঞান/অনুধাবন (Day-2)',
            subjects: ['অধ্যায় ৪: কাজ, শক্তি ও ক্ষমতা', 'অধ্যায় ৭: তরঙ্গ ও শব্দ']
        },
        {
            day: 11, date: '১৮/০২/২০২৬', isoDate: '2026-02-18T09:00:00', title: 'পদার্থবিজ্ঞান: MCQ ও জ্ঞান/অনুধাবন (Day-3)',
            subjects: ['অধ্যায় ৮: আলোর প্রতিফলন', 'অধ্যায় ১০: স্থির বিদ্যুৎ']
        },
        {
            day: 12, date: '১৯/০২/২০২৬', isoDate: '2026-02-19T09:00:00', title: 'পদার্থবিজ্ঞান পরীক্ষা (MCQ ও জ্ঞান/অনুধাবন)',
            subjects: ['সম্পূর্ণ পদার্থবিজ্ঞান রিভিশন'], isExam: true
        },
        {
            day: 13, date: '২০/০২/২০২৬', isoDate: '2026-02-20T09:00:00', title: 'রসায়ন: MCQ ও জ্ঞান/অনুধাবন (Day-1)',
            subjects: ['অধ্যায় ৩: পদার্থের গঠন', 'অধ্যায় ৪: পর্যায় সারণি', 'অধ্যায় ৫: রাসায়নিক বন্ধন (আংশিক)']
        },
        {
            day: 14, date: '২১/০২/২০২৬', isoDate: '2026-02-21T09:00:00', title: 'রসায়ন: MCQ ও জ্ঞান/অনুধাবন (Day-2)',
            subjects: ['অধ্যায় ৬: মোলের ধারণা ও রাসায়নিক গণনা', 'অধ্যায় ৭: রাসায়নিক বিক্রিয়া']
        },
        {
            day: 15, date: '২২/০২/২০২৬', isoDate: '2026-02-22T09:00:00', title: 'রসায়ন ও পরীক্ষা (MCQ ও জ্ঞান/অনুধাবন)',
